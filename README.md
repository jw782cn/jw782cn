...
| ----------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| GPT, ComfyUI                     | - ✨[RepoChat](https://github.com/jw782cn/RepoChat-200k), Chat with GitHub Repo <br /> - ✨[ComfyUI-Catcat](https://github.com/jw782cn/ComfyUI-Catcat), extension of comfyui <br /> - ✨[Raby](https://github.com/jw782cn/PetGame), text-based pet game powered by gpt4<br />- ✨[Curio](https://github.com/jw782cn/curio), AI teacher powered by gpt<br />- [BookGPT](https://github.com/jw782cn/bookgpt-test), practice building infrastructure<br />- [Image Generation](https://github.com/jw782cn/Image-Generation-DALLE2), practice class construction<br />- ✨[AI character system](https://github.com/jw782cn/AI-Character-System), system design | - Claude, Streamlit <br />- ComfyUI <br />- ChatGPT, Svelte (prompt engineer)<br />- ChatGPT, React<br />- Python, ChatGPT<br />- Python, DALLE2<br />- Python, ChatGPT |
